...
superPowers = input("Your super power: ")
print()
...
print("\033[31m'Our final battle begins!'\033[0m shouts the evil", enemy,"Cleary missing the fact that", name, "has the power of\033[35m", superPowers,"\033[0mwhich means they'll win quite easily")